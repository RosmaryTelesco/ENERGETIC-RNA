...
if st.button('Entrenar Modelo'):
    ...
    st.success('Modelo LSTM entrenado y guardado como energy_model.h5')
...
if st.button('Generar Predicción'):
    if not os.path.exists('energy_model.h5'):
...
st.info('Desarrollado por un alumno para un proyecto de IA')